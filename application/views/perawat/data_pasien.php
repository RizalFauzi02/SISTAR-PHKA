...
<div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url('users/perawat/editPasien'); ?>" method="post">
                <div class="modal-body">
                    <input type="hidden" name="id_pasien" id="edit_id">
                    <div class="form-group">
                        <label for="edit_nama">Nama Pasien</label>
                        <input type="text" class="form-control" id="edit_nama" name="nama_pasien" readonly>
                    </div>
                    <div class="form-group">
                        <label for="edit_tanggal">Tanggal Lahir</label>
                        <input type="date" class="form-control" id="edit_tanggal" name="tanggal_lahir" readonly>
                    </div>
                    <div class="form-group">
                        <label for="edit_whatsapp">No WhatsApp</label>
                        <input type="text" class="form-control" id="edit_whatsapp" name="no_whatsapp" readonly>
                        <p>*Penulisan nomor WhatsApp: <b>6285956xxxxxx</b></p>
                    </div>
                    <div class="form-group">
                        <label for="jaminan">Jaminan</label>
                        <select class="form-control select-search" id="jaminan_edit" name="jaminan" disabled>
                    ...
                    <input type="text" name="jaminan" hidden>
                    <!-- <input type="text" value="<?= $user['username']; ?>" name="petugas_edit"> -->
                    <div class="form-group">
...
<script>
    ...
    $(document).on("click", ".edit-btn", function() {
        ...
        setTimeout(function() {
            ...
            $('input[name="jaminan"]').val(jaminan);
    ...
    $(document).ready(function() {
        ...
        let table = $('#logTable').DataTable({
            ...
            "destroy": true,
            "ajax": {
                "url": "<?= base_url('users/perawat/get_pasien_nulKamar') ?>",
                "type": "GET",
