...
<head>
    ...
    <script src="<?= base_url('assets/app-assets/Bootstrap 4/Template') ?>/global_assets/js/plugins/forms/wizards/steps.min.js"></script>
    <script src="<?= base_url('assets/app-assets/Bootstrap 4/Template') ?>/global_assets/js/plugins/forms/selects/select2.min.js"></script>
    <script src="<?= base_url('assets/app-assets/Bootstrap 4/Template') ?>/global_assets/js/plugins/forms/styling/uniform.min.js"></script>
    <script src="<?= base_url('assets/app-assets/Bootstrap 4/Template') ?>/global_assets/js/plugins/forms/inputs/inputmask.js"></script>
    <script src="<?= base_url('assets/app-assets/Bootstrap 4/Template') ?>/global_assets/js/plugins/forms/validation/validate.min.js"></script>
    <script src="<?= base_url('assets/app-assets/Bootstrap 4/Template') ?>/global_assets/js/plugins/extensions/cookie.js"></script>

    <script src="<?= base_url('assets/app-assets/Bootstrap 4/Template/layout_1/LTR/default/full/') ?>assets/js/app.js"></script>
    <script src="<?= base_url('assets/app-assets/Bootstrap 4/Template/layout_1/LTR/default/full/') ?>assets/js/custom.js"></script>
    <script src="<?= base_url('assets/app-assets/Bootstrap 4/Template') ?>/global_assets/js/demo_pages/login.js"></script>
    <!-- <script src="<?= base_url('assets/app-assets/Bootstrap 4/Template') ?>/global_assets/js/demo_pages/form_wizard.js"></script> -->
    <!-- /theme JS files -->
