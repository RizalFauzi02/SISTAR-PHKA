							...
							<script>
							    ...
							    function confirmDeleteAll() {
							        Swal.fire({
							            title: 'Apakah Anda yakin akan mengahapus semua log WhatsApp?',
							            html: "<b>Semua history log WhatsApp akan dihapus!</b> Dan tidak akan dapat dikembalikan lagi.",
							            ...
							            preConfirm: () => {
							                window.location.href = "<?= base_url('users/superadmin/delete_log_wa_all') ?>";
							            }
							        });
							    }
							    ...
							    function confirmDeleteByDate() {
							        ...
							        Swal.fire({
							            ...
							            cancelButtonText: 'Batal',
							            preConfirm: () => {
							                window.location.href = "<?= base_url('users/superadmin/delete_log_wa_by_date') ?>?dari=" + dari + "&sampai=" + sampai;
							            }
							        });
							    }
							</script>